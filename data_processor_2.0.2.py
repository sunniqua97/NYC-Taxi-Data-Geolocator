...
B = input("What is the column index of the pickup_long?")
B = int(B)
C = input("What is the column index of the pickup_lat?")
C = int(C)
D = input("What is the column index of the dropoff_long?")
D = int(D)
E = input("What is the column index of the dropoff_lat?")
E = int(E)


createLocationArray(A,B,C,D,E)
